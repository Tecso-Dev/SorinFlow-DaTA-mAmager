...
// A listing's photos: a strip of thumbnails, and a full-screen viewer that
// zooms (wheel, double-click/tap, +/−), pans when zoomed (drag), and steps
// through the photos (arrows, keys). Radix Dialog for the focus trap and Esc.
...
/** Only our own images and https ones reach an <img src>. */
...
export function PhotoStrip({ images, size = 92 }: { images: string[] | null | undefined; size?: number }) {
      ...
      <div className="-mx-1 flex gap-2 overflow-x-auto px-1 pb-1 [scrollbar-width:thin]">
        {list.map((src, i) => (
          <motion.button
            ...
            className="relative shrink-0 cursor-zoom-in overflow-hidden rounded-xl border bg-muted shadow-sm outline-none focus-visible:ring-2 focus-visible:ring-ring"
